...
namespace MyMod.src
{
    ...
    class BeamGrenadeGun : Gun
    {
        ...
        public BeamGrenadeGun(float xval, float yval) : base(xval, yval)
        {
            this.ammo = 6;
            this._type = "gun";
            this._editorName = "Beam Grenade Gun";
            this._bio = "The Chief sends his regards";
            this.graphic = new Sprite(GetPath("BeamGrenadeGun"));
        ...
        public override void OnReleaseAction()
        {
            if (this._cooldown == 0f && this.ammo > 0)
            {
                ...
                {
                    BeamGrenade grenade = new BeamGrenade(0, 0);
