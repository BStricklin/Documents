...
namespace MyMod.src
{
    ...
    class ForeverGrenade : Grenade
    {
        ...
        public ForeverGrenade(float xval, float yval) : base(xval, yval)
        {
            this.ammo = 1;
            this._editorName = "Forever Grenade";
            this._bio = "H.G. Wells had it right";
            this._ammoType = new ATShrapnel();
            this._ammoType.penetration = 0.4f;
            this._type = "gun";
            _sprite = new SpriteMap(GetPath("foreverGrenade"), 16, 16, false);
        ...
        {
            ForeverGrenade grenade = new ForeverGrenade(0, 0);
